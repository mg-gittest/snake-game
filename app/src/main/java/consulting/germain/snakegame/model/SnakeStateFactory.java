...
public class SnakeStateFactory {
    ...
    public static final Tile headTileDefault = Tile.get(TileSnakeHead.EAST);
    public static final Tile tailTileDefault = Tile.get(TileSnakeTail.EAST);
    public static final Tile bodyTileDefault = Tile.get(TileSnakeBody.EAST);
