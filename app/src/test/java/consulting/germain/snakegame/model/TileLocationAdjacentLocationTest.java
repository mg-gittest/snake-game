...
public class TileLocationAdjacentLocationTest {
     ...
     * @throws Exception
     */
    public TileLocationAdjacentLocationTest(
            final int xDiff,
            final int yDiff,
    ...
    public void testAdjacentLocation() throws Exception {
        ...
        TileLocation candidate =
                new TileLocation(new Location(xExpect + xDiff, yExpect + yDiff), tileCake);

        assertEquals(msg, expectResult, target.isAdjacentLocation(candidate));
    }
}
